...
public class EDAlertSnackbar {
	...
	companion object {
		...
		fun success(context: Context, view: View, msg: String, length: Int, iconType: String = ICON_OUTLINED): EDAlertSnackbar {
			return EDAlertSnackbar().create(SNACKBAR_TYPE_SUCCESS, context, view, msg, length, iconType)
		}
		
		fun warning(context: Context, view: View, msg: String, length: Int, iconType: String = ICON_OUTLINED): EDAlertSnackbar {
			return EDAlertSnackbar().create(SNACKBAR_TYPE_WARNIG, context, view, msg, length, iconType)
		}
		
		fun info(context: Context, view: View, msg: String, length: Int, iconType: String = ICON_OUTLINED): EDAlertSnackbar {
			return EDAlertSnackbar().create(SNACKBAR_TYPE_INFO, context, view, msg, length, iconType)
		}
		
		fun failed(context: Context, view: View, msg: String, length: Int, iconType: String = ICON_OUTLINED): EDAlertSnackbar {
			return EDAlertSnackbar().create(SNACKBAR_TYPE_FAILED, context, view, msg, length, iconType)
		}
	}
	
	@SuppressLint("ShowToast")
	private fun create(type: Int, context: Context, v: View, s: String, i: Int, iconType: String): EDAlertSnackbar {
